...
Stores short turn summaries per WebSocket session; injects relevant snippets into LLM context.
        ...
        try:
            ...
            try:
                ...
                if n > _MAX_DOCS_PER_SESSION:
                    ...
                    drop = all_ids[: max(0, n - _MAX_DOCS_PER_SESSION)]
                    if drop:
                        col.delete(ids=drop[:20])
            except Exception:
                pass
            return
        except Exception as e:
