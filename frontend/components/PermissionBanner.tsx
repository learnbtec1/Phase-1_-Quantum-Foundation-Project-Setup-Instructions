        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-300 leading-relaxed">
              صوت الأفاتار والردود الصوتية لا يعتمد على الميكروفون — يمكنك الكتابة والاستماع حتى برفض إذن المايك.
              <br />
              الرجاء السماح بالمايك من إعدادات المتصفح ثم اضغط «تشغيل الآن» إذا أردت التحدث صوتاً.
              <br />
