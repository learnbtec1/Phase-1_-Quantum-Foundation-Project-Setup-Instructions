...
export function BehaviorBrainHost({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      /* Latest continuity snapshot at behavior host teardown — ref holds mutable object state, not DOM */
      // eslint-disable-next-line react-hooks/exhaustive-deps
      const continuityAtUnmount = emotionContinuityRef.current;
      resetEmotionContinuity(continuityAtUnmount);
      emotionDriftRef.current = { ...continuityAtUnmount.display };
    };
