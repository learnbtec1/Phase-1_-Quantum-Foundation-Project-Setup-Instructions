  ...
  return (
    <Link href={href} className={isLarge ? "md:col-span-2 row-span-2" : ""}>
      ...
      >
        ...
        <div className="relative h-full p-8 flex flex-col justify-between z-10 relative-transform custom-transform">
          <div>
            <div className={`w-14 h-14 rounded-2xl mb-6 flex items-center justify-center bg-gradient-to-br border border-white/10 group-hover:scale-110 transition-transform duration-500 shadow-lg custom-style`}>
