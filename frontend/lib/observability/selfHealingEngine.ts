...
import { peekSharedAudioContext, resumeSharedAudioContext } from '@/lib/audio/avatarAudioContext';
...
function healAudioContext(): void {
  ...
  /** Never instantiate here — observability ticks are not user gestures. */
